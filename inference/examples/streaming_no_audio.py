...
# Import the streaming client directly from our modified file
from inference.client.streaming_no_audio import DiaStreamingClient

def main():
    """Example of generating audio with Dia TTS"""
    ...
    print(f"Generating speech for the following text:")
    print(f"---\n{text}\n---")
    ...
    if success:
        ...
        print(f"Audio saved to: streamed_output.wav")
        return 0
    else:
