...
This version doesn't depend on PyAudio and just saves the audio to file
"""
import os
import sys
import requests
...
class DiaStreamingClient:
    ...
    def stream_speech(self, text, temperature=1.3, top_p=0.95, seed=None, audio_prompt=None, 
        ...
        try:
            ...
            print("Waiting for generation to complete... (real-time audio playback disabled)")
            progress_chars = ["|", "/", "-", "\\"]
            progress_idx = 0
            ...
            while True:
                ...
                sys.stdout.write(f"\rProcessing {progress_chars[progress_idx]} ")
                sys.stdout.flush()
